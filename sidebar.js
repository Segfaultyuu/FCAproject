...
<div class="nav-flyout" id="flyout-tools">
      ...
      <a class="flyout-item" href="#">ProTrader Tools</a>
      <a class="flyout-item" href="#">Technical Analysis</a>
      <a class="flyout-item" href="#">ProTrader Platform</a>
      <a class="flyout-item${page === 'Tools_Notional_Volume_Calculator.html' ? ' active' : ''}" href="Tools_Notional_Volume_Calculator.html">Notional Volume Calculator</a>
      <a class="flyout-item" href="#">Acuity AnalysisIQ</a>
      <a class="flyout-item" href="#">Daily Newsletter</a>
    </div>`;
  ...
  if (mobileLogoutRow) mobileLogoutRow.addEventListener('click', () => { window.location.href = 'login.html'; });
